%此代码为2题2问所用函数的代码,若想得到结果，请打开后在命令行中输入[x,fval] = fmincon(@func_sec_2,[35000,0.5],[],[],[],[],[0,0],[100000,1]),注意p取负
function p=func_sec_2(x)
c=x(1);
index=x(2);
m1=4866;%浮子质量
m2=2433;%振子质量
...
for i=1:1000000
    t=t+deltat;
    sigma1=c*((abs(v1-v2))^index);%阻尼系数，力以向外扩张为正
